                ...
                <form action="{{ route('produk.admin.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_produk" class="form-control @error('nama_produk') is-invalid @enderror" value="{{ old('nama_produk') }}" id="nama_produk" placeholder="Masukan Nama Produk" required autocomplete="nama_produk" autofocus>
                      @error('nama_produk')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="merk_produk" class="form-control @error('merk_produk') is-invalid @enderror" id="merkProduk" placeholder="Masukan Merk Produk" required autocomplete="merk_produk">
                        @error('merk_produk')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
