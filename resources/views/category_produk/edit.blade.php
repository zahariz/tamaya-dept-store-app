    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Master Category Prduk</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            @foreach ($data as $row)
                            <form action="{{ route("category.produk.admin.update", $row->id) }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_category_produk"
                                            ...
                                            value="{{ $row->nama_category_produk }}" id="nama_category_produk"
